...
# encoding: utf-8
'''
# @Time    : 2024/4/13 23:32
# @Author  : zhongyu
# @Site    : 
# @File    : shots_change.py
...
if __name__ == '__main__':
    ...
    #     np.random.shuffle(temp_training_shots)
    #
    #     # Split the shuffled data into new training and validation sets
    #     new_training_shots = temp_training_shots[:827]
    #     new_valid_shots = temp_training_shots[827:]
    #     print('training info:')
    ...
    #     np.save('..//..//file_repo//info//dataset//random_827//training_shots_{}.npy'.format(i + 1), new_training_shots)
    #     np.save('..//..//file_repo//info//dataset//random_827//valid_shots_{}.npy'.format(i + 1), new_valid_shots)
    ...
    print(df)
    # df.to_csv('..//..//file_repo//info//dataset//random_827//random_827_info.csv')
